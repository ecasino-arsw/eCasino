...
public class Roulette implements IGame {
    ...
    /*
    public Roulette(long tableId, long lobbyId) {
        this.tableId = tableId;
        this.tableId = lobbyId;
        this.listNumbersRoulette = generateNumbersRoulette();
    }*/
    ...
    private ArrayList<Integer> generateNumbersRoulette() {
        ...
        return new ArrayList<>(Arrays.asList(37,1,13,36,24,3,15,34,22,5,17,32,20,7,11,30,26,9,28,0,2,14,35,23,4,16,33,21,6,18,31,19,8,12,29,25,10,27));
    }
